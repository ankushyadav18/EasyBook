        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-6">
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-6 transition-all duration-300 hover:border-primary/40 hover:bg-primary/15 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 pb-4 border-b border-primary/10">
              <h2 className="text-xl font-bold text-black dark:text-gray-400">👤 Profile</h2>

              <button className="w-full sm:w-auto px-4 py-2 rounded-xl bg-primary text-gray-900 dark:text-white text-sm font-medium transition-all duration-300 hover:bg-primary/90 hover:scale-105 hover:shadow-lg hover:shadow-primary/30">
                Edit Profile
              </button>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex-1 space-y-4 text-center sm:text-left">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-black dark:text-gray-400 tracking-wide">
                    {user?.name}
                  </h3>
                </div>
                ...
                <div>
                  ...
                  <h3 className="font-medium text-gray-900 dark:text-gray-300 break-all">
                    {user?.email}
                  </h3>
                </div>
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-6 transition-all duration-300 hover:border-primary/40 hover:bg-primary/15 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
            ...
            <div className="space-y-5">
              {/* Change Password */}
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-xl bg-gray-100 dark:bg-black/20 border border-white/5 p-4 transition-all duration-300 hover:bg-primary/10 hover:border-primary/20">
                <div>
                ...
                <button className="px-4 py-2 rounded-xl bg-primary text-gray-900 dark:text-white text-sm font-medium transition-all duration-300 hover:bg-primary/90 hover:scale-105 hover:shadow-lg hover:shadow-primary/30">
                  Change
                </button>
              </div>

              {/* Two Factor */}
              <div className="flex items-center justify-between rounded-xl bg-gray-100 dark:bg-black/20 border border-white/5 p-4 transition-all duration-300 hover:bg-primary/10 hover:border-primary/20">
                <div>
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-6 transition-all duration-300 hover:border-primary/40 hover:bg-primary/15 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-primary/10">
              <h2 className="text-xl font-bold text-black dark:text-gray-400">🎛 Dashboard Preferences</h2>
            ...
            <div className="space-y-5">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 rounded-xl bg-gray-100 dark:bg-black/20">
                <div>
          ...
          {/* Appearance */}
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-6 transition-all duration-300 hover:border-primary/40 hover:bg-primary/15 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
            <h2 className="text-xl font-bold text-black dark:text-gray-400 mb-6">🎨 Appearance</h2>
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-6 transition-all duration-300 hover:border-primary/40 hover:bg-primary/15 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
              <div className="bg-gray-100 dark:bg-black/20 border border-white/5 rounded-xl p-4 transition-all duration-300 hover:bg-primary/10 hover:border-primary/20">
                <p className="text-gray-600 dark:text-gray-400 text-sm">Version</p>
                <h3 className="font-semibold mt-1">v1.0.0</h3>
              </div>

              <div className="bg-gray-100 dark:bg-black/20 border border-white/5 rounded-xl p-4 transition-all duration-300 hover:bg-primary/10 hover:border-primary/20">
                <p className="text-gray-600 dark:text-gray-400 text-sm">Environment</p>
              ...
              <div className="bg-gray-100 dark:bg-black/20 border border-white/5 rounded-xl p-4 transition-all duration-300 hover:bg-primary/10 hover:border-primary/20">
                <p className="text-gray-600 dark:text-gray-400 text-sm">Backend</p>
          ...
          <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6 transition-all duration-300 hover:border-primary/40 hover:bg-primary/15 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
            <h2 className="text-xl font-bold text-black dark:text-gray-400 text-red-400 mb-3">
              ⚠ Danger Zone
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="w-full sm:w-auto px-5 py-3 rounded-xl bg-red-600 text-gray-900 dark:text-white transition-all duration-300 hover:bg-red-500 hover:scale-105 hover:shadow-lg hover:shadow-red-500/30">
                Clear Cache
              </button>
              <button className="w-full sm:w-auto px-5 py-3 rounded-xl bg-red-600 text-gray-900 dark:text-white transition-all duration-300 hover:bg-red-500 hover:scale-105 hover:shadow-lg hover:shadow-red-500/30">
                Reset Dashboard
