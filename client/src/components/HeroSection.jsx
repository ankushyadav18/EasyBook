...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      ...
      <div className="flrx items-center gap-4 text-gray-300">
      ...
      <button onClick={()=> navigate('/movies')} className="flex items-center gap-1 ps-6 py-3 text-sm bg-primary hover:big-primary-dull transition rounded-full font-medium cursor-pointer">
        Explore Movies
